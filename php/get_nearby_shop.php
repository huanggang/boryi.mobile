...
$query_1 = "SELECT ns_owner_openid, ns_certified_openid, ns_end, ns_business_hours, ns_services, ns_products, ns_content, ns_free_parking, ns_free_wifi, ns_cards, ns_wx, ns_qq, ns_phone, ns_address, ns_views FROM nearby_shop_info_ns WHERE ns_id=".sqlstrval($id);
...
if ($row = mysqli_fetch_array($result))
{
  ...
  $json = "{\"ooi\":".jsonstr($ns_owner_openid).",\"coi\":".jsonstr($ns_certified_openid).",\"e\":".jsonstr($ns_end).",\"bh\":".jsonstr($ns_business_hours).",\"sv\":".jsonstr($ns_services).",\"pd\":".jsonstr($ns_products).",\"ct\":".jsonstr($ns_content).",\"fp\":".jsonstrval($ns_free_parking).",\"fw\":".jsonstrval($ns_free_wifi).",\"cd\":".jsonstrval($ns_cards).",\"wx\":".jsonstr($ns_wx).",\"qq\":".jsonstr($ns_qq).",\"phn\":".jsonstr($ns_phone).",\"add\":".jsonstr($ns_address).",\"vws\":".jsonstrval($ns_views)."}";
