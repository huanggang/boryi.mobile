...
$query_1 = "SELECT nj_end, nj_social_security, nj_housing_fund, nj_annual_vacations, nj_housing, nj_meals, nj_travel, nj_overtime, nj_nightshift, nj_requirement, nj_description, nj_benefit, nj_phone, nj_email, nj_address, nj_views FROM nearby_job_info_nj WHERE nj_id=".sqlstrval($id);
