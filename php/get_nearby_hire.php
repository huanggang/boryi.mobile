...
$query_1 = "SELECT nh_end, nh_content, nh_phone, nh_email, nh_address, nh_views FROM nearby_hire_info_nh WHERE nh_id=".sqlstrval($id);
...
if ($row = mysqli_fetch_array($result))
{
  ...
  $json = "{\"e\":".jsonstr($nh_end).",\"c\":".jsonstr($nh_content).",\"ph\":".jsonstr($nh_phone).",\"em\":".jsonstr($nh_email).",\"ad\":".jsonstr($nh_address).",\"vw\":".jsonstrval($nh_views)."}";
